...
export function WelcomeStep({ onScanClick, onManualClick }: WelcomeStepProps) {
  ...
  return (
    <div className="py-4 sm:py-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="text-center mb-6 sm:mb-8">
        <h1 className="text-3xl sm:text-4xl font-bold text-theme tracking-tight mb-3">
          Welcome to BrewOS
        </h1>
        <p className="text-theme-muted text-base sm:text-lg max-w-md mx-auto leading-relaxed">
      ...
      {/* Action buttons */}
      <div className="space-y-3 sm:space-y-4 max-w-sm mx-auto mb-6 sm:mb-10">
        <Button
          className="w-full py-4 sm:py-5 text-base sm:text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02]"
          onClick={onScanClick}
        >
        ...
        <button
          className="w-full py-2 sm:py-3 text-theme-muted hover:text-theme transition-colors duration-200 font-medium flex items-center justify-center text-sm sm:text-base"
      ...
      <div className="border-t border-theme/10 pt-4 sm:pt-8">
