        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-theme-muted">
              Choose from our supported list
            </p>
          </div>
        </div>
  ...
  return (
    <div className="py-3 xs:py-6">
      <div className="text-center mb-4 xs:mb-8">
        ...
        <h2 className="text-xl xs:text-2xl font-bold text-theme mb-1 xs:mb-2">
          Select Your Machine
        </h2>
...
function MachineSelector({
  ...
  return (
    <div className={compact ? "space-y-1" : "space-y-1.5 xs:space-y-2"}>
      <label
        className={cn(
          "block font-medium text-theme",
          compact ? "text-xs" : "text-xs xs:text-sm"
        )}
      >
      ...
      <div className="relative">
        <select
          ...
          className={cn(
            ...
            compact
              ...
              : "px-3 xs:px-4 py-2.5 xs:py-3 text-xs xs:text-sm xs:rounded-xl",
        ...
        <ChevronDown
          className={cn(
            "absolute right-3 top-1/2 -translate-y-1/2 text-theme-muted pointer-events-none",
            compact ? "w-4 h-4" : "w-4 h-4 xs:w-5 xs:h-5"
          )}
        />
      </div>
      {error && (
        <p
          className={cn(
            "text-red-500",
            compact ? "text-[10px]" : "text-[10px] xs:text-xs"
          )}
        >
          {error}
        </p>
  ...
  if (compact) {
    return (
      <div className="p-3 rounded-lg bg-accent/5 border border-accent/20 space-y-2 h-full">
        ...
        <p className="text-[10px] text-theme-muted line-clamp-2">
          {machine.description}
        </p>
