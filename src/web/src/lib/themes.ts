...
export const themes: Record<ThemeId, Theme> = {
  ...
  // Roasted - Deep chocolate dark theme with warm amber accents
  roasted: {
    id: "roasted",
    name: "Roasted",
    ...
    colors: {
      ...
      accent: "#c4895c",
      accentLight: "#d9a880",
      accentGlow: "rgba(196, 137, 92, 0.32)",
      cardBg: "#241c18",
      border: "#4a403a",
      borderLight: "#3a302a",
      shadowColor: "rgba(0, 0, 0, 0.4)",
      navBg: "#1a1210",
      navActiveBg: "#c4895c",
      navActiveText: "#1a1210",
      navInactiveText: "#9c8a7a",
      navHoverBg: "#2a211c",
      headerGlassBg: "rgba(26, 18, 16, 0.95)",
      headerGlassBlur: "12px",
    },
  },
